...
<tr> 
				...
				<tr> 
					...
					<td >
						<input name='phone1'  type='text' value="${qdto.phone1 }">-
					</td>
					<td >
						<input name='phone2'  type='text' value="${qdto.phone2 }">-
					</td>
					<td >
						<input name='phone3'  type='text' value="${qdto.phone3 }">
					</td>
				</tr>
				<tr> 
					<td height='1' colspan='4' bgcolor='#cecfce'></td>
				...
				<tr> 
					...
					<td height='25' colspan='3' valign='top'>
						&nbsp;<textarea name='content'  type='text' cols='60' rows='50'>${qdto.content }</textarea>
					</td>
				</tr>
				<tr> 
					<td height='1' colspan='4' bgcolor='#cecfce'></td>
				...
				<tr align='center'> 
					...
					<td height='25' colspan='4'><input type="button" value="수정 완료" id="qnaUpdate">  
...
$(document).ready(function(){
    $("#qnaUpdate").on("click",function(){
     document.myForm.action="QNAUpdateServlet?qna_num=${qdto.qna_num}&userid=${sessionScope.login.userid}";
