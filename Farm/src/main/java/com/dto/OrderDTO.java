...
public class OrderDTO {
	...
	public OrderDTO(int order_num, String userid, String orderName, String phone, String post1, String post2,
			String addr1, String addr2, String gCode, String gName, int gPrice, int gAmount, String gSize,
	...
	public String toString() {
		return "OrderDTO [order_num=" + order_num + ", userid=" + userid + ", orderName=" + orderName + ", phone="
				...
				+ gCode + ", gName=" + gName + ", gPrice=" + gPrice + ", gAmount=" + gAmount + ", gSize=" + gSize
				+ ", gImage1=" + gImage1 + ", payMethod=" + payMethod + ", orderDay=" + orderDay + "]";
	}
